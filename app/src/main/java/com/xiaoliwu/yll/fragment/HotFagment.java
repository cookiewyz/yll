 ...
 * 热门界面
 */
public class HotFagment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, AbsListView.OnScrollListener, AdapterView.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view1 = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_home, null);
    ...
    public void dataRequest() {
        ...
        httpUtils.send(HttpRequest.HttpMethod.GET, ServerUrl.HOT + "&offset=" + offset,
                new RequestCallBack<String>() {
                    ...
                    public void onSuccess(ResponseInfo<String> responseInfo) {
                        ...
                        for (int i = 0; i < items.size(); i++) {
                            JSONObject data = (items.getJSONObject(i)).getJSONObject("data");
