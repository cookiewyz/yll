 ...
 */
public class RecreationFragment extends Home_Super {
    private Super_Details_Activity super_details_fragment = new Super_Details_Activity();
    @Override
    protected void init() {
        pathone = ServerUrl.HOME_RECREATION;
    }
